...
var Raised$1 = /* @__PURE__ */create("S_Core-RescriptSchema.Raised");
...
function transform$1(b, input, operation) {
  if (!input.a) {
...
function compile$1(builder, schema, flag) {
...
function operationFn(s, o) {
  ...
  var ss = o & 32 ? s["~r"]() : s;
  var f = compile$1(ss.b, ss, o);
  ((s[o] = f));
  return f;
}

function compile$1$1(schema, input, output, mode, typeValidationOpt) {
...
function recursive$1(fn) {
  ...
  var placeholder = {
    ...
    b: (function (b, input, param, param$1) {
        return transform$1(b, input, (function (_b, input) {
                      return map(r, input);
                    }));
      }),
    "~r": (function () {
...
function setName$1(schema, name) {
...
function removeTypeValidation$1(schema) {
...
function internalRefine(schema, refiner) {
  return makeSchema(schema.n, schema.t, schema.m, (function (b, input, selfSchema, path) {
                return transform$1(b, schema.b(b, input, schema, path), (function (b, input) {
                              var bb = {
                                c: "",
                                l: "",
                                a: initialAllocate,
                ...
                return makeReverseSchema(schema$1.n, schema$1.t, schema$1.m, (function (b, input, selfSchema, path) {
                              var input$1 = transform$1(b, input, (function (b, input) {
...
function transform$1$1(schema, transformer) {
  return makeSchema(schema.n, schema.t, schema.m, (function (b, input, selfSchema, path) {
...
var schema$1 = makeSchema(primitiveName, "never", empty, builder, undefined, toSelf);
...
var schema$1$1 = makeSchema(primitiveName, "unknown", empty, invalidJson, undefined, toSelf);
    ...
    return makeSchema((function () {
                ...
                _0: schemas
                  ...
                  for(var idx = 0 ,idx_finish = schemas.length; idx < idx_finish; ++idx){
                    ...
                    var schemas$1 = get$2(byTypeFilter, typeFilterCode);
...
function $$enum$1(values) {
  return factory$5(values.map(literal$1));
}

function preprocess$1(schema, transformer) {
  ...
  if (typeof unionSchemas === "object" && unionSchemas.TAG === "union") {
    return makeSchema(schema.n, {
                ...
                _0: unionSchemas._0.map(function (unionSchema) {
                      return preprocess$1(unionSchema, transformer);
                    })
  ...
  return makeSchema(schema.n, schema.t, schema.m, (function (b, input, selfSchema, path) {
                ...
                var asyncParser = match.a;
                if (asyncParser !== undefined) {
                  return transform$1(b, embedAsyncOperation(b, input, asyncParser), (function (b, input) {
                                return parseWithTypeValidation(b, schema, input, path);
                              }));
                } else {
                  return parseWithTypeValidation(b, schema, input, path);
...
function list$1(schema) {
  return transform$1$1(factory$2(schema), (function (param) {
                return {
                        p: fromArray$1,
                        s: toArray$1
                      };
...
function $$catch$1(schema, getFallbackValue) {
  return makeSchema(schema.n, schema.t, schema.m, (function (b, input, selfSchema, path) {
                var inputVar = input.v(b);
                return withCatch(b, input, (function (b, errorVar) {
                              return {
...
function nested(fieldName) {
  ...
  var schema = makeSchema(name$2, {
        ...
        unknownKeys: globalConfig.u,
        advanced: false
      }, empty, builder$1, typeFilter$1, reverse$1$1);
...
function internalInline(schema, maybeVariant, param) {
  ...
  if (typeof literal !== "object") {
    ...
    switch (literal.TAG) {
      case "literal" :
          ...
          break;
      case "option" :
          inlinedSchema = "S.option(" + internalInline(literal._0, undefined) + ")";
          break;
      case "null" :
          inlinedSchema = "S.null(" + internalInline(literal._0, undefined) + ")";
          break;
      case "array" :
          inlinedSchema = "S.array(" + internalInline(literal._0, undefined) + ")";
          break;
      case "object" :
          var items = literal.items;
          inlinedSchema = items.length !== 0 ? "S.object(s =>\n  {\n    " + items.map(function (item) {
                    return item.inlinedLocation + ": s.field(" + item.inlinedLocation + ", " + internalInline(item.schema, undefined) + ")";
                  }).join(",\n    ") + ",\n  }\n)" : "S.object(_ => ())";
          break;
      case "tuple" :
          ...
          if (len >= 4) {
            ...
            switch (len) {
              ...
              case 1 :
                  var s0 = items$1[0];
                  inlinedSchema = "S.tuple1(" + internalInline(s0.schema, undefined) + ")";
                  break;
              case 2 :
                  var s0$1 = items$1[0];
                  var s1 = items$1[1];
                  inlinedSchema = "S.tuple2(" + internalInline(s0$1.schema, undefined) + ", " + internalInline(s1.schema, undefined) + ")";
                  break;
              case 3 :
                  var s0$2 = items$1[0];
                  var s1$1 = items$1[1];
                  var s2 = items$1[2];
                  inlinedSchema = "S.tuple3(" + internalInline(s0$2.schema, undefined) + ", " + internalInline(s1$1.schema, undefined) + ", " + internalInline(s2.schema, undefined) + ")";
                  break;
          ...
          if (exit === 1) {
            inlinedSchema = "S.tuple(s => (" + items$1.map(function (schema, idx) {
                    return "s.item(" + idx + ", " + internalInline(schema.schema, undefined) + ")";
                  }).join(", ") + "))";
          }
          break;
      case "union" :
          ...
          inlinedSchema = "S.union([" + literal._0.map(function (s) {
                  var variantName = s.n();
                  var n = get$2(variantNamesCounter, variantName);
                  ...
                  return internalInline(s, inlinedVariant);
                }).join(", ") + "])";
          break;
      case "dict" :
          inlinedSchema = "S.dict(" + internalInline(literal._0, undefined) + ")";
          break;
      case "JSON" :
  ...
  if ($$default !== undefined) {
    unsafeDeleteKey(metadataMap, defaultMetadataId);
  ...
  var message = deprecation$1(schema);
  var inlinedSchema$2 = message !== undefined ? (unsafeDeleteKey(metadataMap, deprecationMetadataId), inlinedSchema$1 + ("->S.deprecate(" + fromString(message) + ")")) : inlinedSchema$1;
  var message$1 = description$1(schema);
  var inlinedSchema$3 = message$1 !== undefined ? (unsafeDeleteKey(metadataMap, descriptionMetadataId), inlinedSchema$2 + ("->S.describe(" + (
...
function inline$1(schema) {
  return internalInline(schema, undefined);
}

function tuple1$1(v0) {
  return tuple$1(function (s) {
              return s.item(0, v0);
            });
}

function tuple2$1(v0, v1) {
...
function intMin$1(schema, minValue, maybeMessage) {
...
function intMax$1(schema, maxValue, maybeMessage) {
...
function port$1(schema, messageOpt) {
...
function floatMin$1(schema, minValue, maybeMessage) {
  var message = maybeMessage !== undefined ? maybeMessage : "Number must be greater than or equal to " + minValue;
...
function floatMax$1(schema, maxValue, maybeMessage) {
  var message = maybeMessage !== undefined ? maybeMessage : "Number must be lower than or equal to " + maxValue;
  return addRefinement(schema, metadataId$3, {
              kind: {
                TAG: "Max",
...
function arrayMinLength$1(schema, length, maybeMessage) {
...
function arrayMaxLength$1(schema, length, maybeMessage) {
...
function arrayLength$1(schema, length, maybeMessage) {
...
function stringMinLength$1(schema, length, maybeMessage) {
...
function stringMaxLength$1(schema, length, maybeMessage) {
...
function stringLength$1(schema, length, maybeMessage) {
...
function datetime$1(schema, messageOpt) {
  ...
  return transform$1$1(set$2(schema, metadataId$1, refinements !== undefined ? refinements.concat(refinement) : [refinement]), (function (s) {
                return {
                        p: (function (string) {
...
function trim$1(schema) {
  ...
  return transform$1$1(schema, (function (param) {
                return {
                        p: transformer,
                        s: transformer
                      };
...
function setGlobalConfig$1(override) {
  globalConfig.r = 0;
...
var never$1 = schema$1;

var unknown$1 = schema$1$1;
...
var option$1 = factory;

var $$null$1$1 = factory$1;

var jsonString$1 = factory$4;

var union$1 = factory$5;

var to$1 = shape$1;

var parseJsonOrThrow$1 = parseOrThrow$1;
...
var deprecate = deprecate$1;

var deprecation = deprecation$1;

var transform = transform$1$1;

var preprocess = preprocess$1;
...
var convertAsyncOrThrow = convertAsyncOrThrow$1;
...
var isAsync = isAsync$1;

var recursive = recursive$1;

var setName = setName$1;

var removeTypeValidation = removeTypeValidation$1;
...
var floatMin = floatMin$1;

var floatMax = floatMax$1;

var arrayMinLength = arrayMinLength$1;

var arrayMaxLength = arrayMaxLength$1;

var arrayLength = arrayLength$1;

var stringMinLength = stringMinLength$1;

var stringMaxLength = stringMaxLength$1;
...
var setGlobalConfig = setGlobalConfig$1;
